...
const Posts = (props) => {
    ...
    console.log(props.user, "from Posts")
    return (
        <div className="flex flex-col justify-center items-center">
         { posts.map((post) => {
            return (
                <div key={post._id} className="relative mb-4 mt-1 p-3 border-b border-gray-800 max-w-[1000px] w-full text-center">
                    <img className="absolute left-0 top-0 h-[90%]" src="https://upload.wikimedia.org/wikipedia/commons/b/b6/Gutenberg_Bible%2C_Lenox_Copy%2C_New_York_Public_Library%2C_2009._Pic_01.jpg" alt=""/>
